...
public class FormsPregSurvContract {

    public static String CONTENT_AUTHORITY = "edu.aku.hassannaqvi.amanhicovid_19study";

    public static abstract class FormsPregSurvTable implements BaseColumns {
        public static final String TABLE_NAME = "FormsPregSurv";
        ...
        public static String PATH = "formspregsurv";
