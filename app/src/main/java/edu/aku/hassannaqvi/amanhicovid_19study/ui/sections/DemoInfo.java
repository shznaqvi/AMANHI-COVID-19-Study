...
import edu.aku.hassannaqvi.amanhicovid_19study.databinding.ActivityDemoInfoBinding;
...
public class DemoInfo extends AppCompatActivity {
    ActivityDemoInfoBinding bi;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        bi = DataBindingUtil.setContentView(this, R.layout.activity_demo_info);
        bi.setCallback(this);
        setupSkips();
    }
