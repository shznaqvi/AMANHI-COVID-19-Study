...
import edu.aku.hassannaqvi.amanhicovid_19study.databinding.SyncListAdapterBinding;
import edu.aku.hassannaqvi.amanhicovid_19study.models.SyncModel;
import edu.aku.hassannaqvi.amanhicovid_19study.utils.AppUtilsKt;
...
public class SyncListAdapter extends RecyclerView.Adapter<SyncListAdapter.SyncListViewHolder> {
    ...
    public class SyncListViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindUser(SyncModel model) {
            ...
            binding.tvTableName.setText(AppUtilsKt.convertStringToUpperCase(model.gettableName()) + " (" + model.getUpLoadsize() + ")");
