...
object CreateTable {
    ...
    const val SQL_CREATE_FORMS = ("CREATE TABLE "
            ...
            + Forms21cmContract.FormsTable.COLUMN_CHILD_RESPONDENT + " TEXT,"
            + Forms21cmContract.FormsTable.COLUMN_DCODE + " TEXT,"
            + Forms21cmContract.FormsTable.COLUMN_UCODE + " TEXT,"
            + Forms21cmContract.FormsTable.COLUMN_CLUSTER + " TEXT,"
            + Forms21cmContract.FormsTable.COLUMN_HHNO + " TEXT,"
    ...
    const val SQL_CREATE_FORMS4M = ("CREATE TABLE "
            ...
            + Form4mmContract.Forms4MTable.COLUMN_CHILD_RESPONDENT + " TEXT,"
            + Form4mmContract.Forms4MTable.COLUMN_DCODE + " TEXT,"
            + Form4mmContract.Forms4MTable.COLUMN_UCODE + " TEXT,"
            + Form4mmContract.Forms4MTable.COLUMN_CLUSTER + " TEXT,"
            + Form4mmContract.Forms4MTable.COLUMN_HHNO + " TEXT,"
