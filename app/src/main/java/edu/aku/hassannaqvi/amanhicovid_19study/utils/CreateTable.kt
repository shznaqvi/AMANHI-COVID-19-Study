...
object CreateTable {
    ...
    const val SQL_CREATE_FORMS21CM = ("CREATE TABLE "
            ...
            + Forms21cmContract.Forms21cmTable.COLUMN_CHILD_RESPONDENT + " TEXT,"
            + Forms21cmContract.Forms21cmTable.COLUMN_DCODE + " TEXT,"
            + Forms21cmContract.Forms21cmTable.COLUMN_UCODE + " TEXT,"
            + Forms21cmContract.Forms21cmTable.COLUMN_CLUSTER + " TEXT,"
            + Forms21cmContract.Forms21cmTable.COLUMN_HHNO + " TEXT,"
    ...
    const val SQL_CREATE_FORMS4MM = ("CREATE TABLE "
            ...
            + Forms4mmContract.Forms4MMTable.COLUMN_CHILD_RESPONDENT + " TEXT,"
            + Forms4mmContract.Forms4MMTable.COLUMN_DCODE + " TEXT,"
            + Forms4mmContract.Forms4MMTable.COLUMN_UCODE + " TEXT,"
            + Forms4mmContract.Forms4MMTable.COLUMN_CLUSTER + " TEXT,"
            + Forms4mmContract.Forms4MMTable.COLUMN_HHNO + " TEXT,"
